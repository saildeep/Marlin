...
#define STRING_CONFIG_H_AUTHOR "(Jonas Koerner, A6 Ramps2130)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 22.87
  #define DEFAULT_Ki 1.58
  #define DEFAULT_Kd 82.92
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.94   // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 50 - 30
  #define RIGHT_PROBE_BED_POSITION 220 - 30
  #define FRONT_PROBE_BED_POSITION 20 + 30
  #define BACK_PROBE_BED_POSITION 190 + 30
