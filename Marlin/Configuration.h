...
#define STRING_CONFIG_H_AUTHOR "(jkoerner,DIY CNC)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {800,  100, 400,5}
...
#define DEFAULT_MAX_FEEDRATE          {40, 120,12,5}
...
#define DEFAULT_MAX_ACCELERATION      { 40, 25, 12 ,100}
